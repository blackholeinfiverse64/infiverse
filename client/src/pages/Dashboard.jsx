    ...
    <div className={`min-h-screen bg-black space-y-8 font-poppins transition-all duration-700 ${
      ...
      <div className="w-full max-w-none">
        ...
        <div className={`gap-8 relative z-10 transition-all duration-500 ${
          ...
          <div className="relative group">
            {/* Electric Background Effects */}
            <div className="absolute inset-0 bg-gradient-to-br from-orange-400/20 via-red-500/15 to-pink-600/20 rounded-2xl blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
            <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-orange-400/10 to-transparent rounded-2xl animate-electric-flow"></div>
            
            {/* Main Card */}
            <div className="relative backdrop-blur-xl bg-black/30 border border-white/20 rounded-2xl shadow-2xl hover:shadow-orange-400/20 transition-all duration-500 hover:border-orange-400/40 hover:scale-[1.02] p-6 h-full">
              {/* Electric Particles */}
              <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none">
                <div className="absolute top-4 left-4 w-1.5 h-1.5 bg-orange-400 rounded-full animate-ping opacity-75"></div>
                <div className="absolute bottom-3 right-5 w-1 h-1 bg-red-400 rounded-full animate-pulse opacity-60"></div>
                <div className="absolute top-12 right-8 w-1 h-1 bg-pink-400 rounded-full animate-bounce opacity-70"></div>
              </div>
              
              {/* Section Header */}
              <div className="flex items-center gap-3 mb-6 relative z-10">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400/30 to-red-500/30 rounded-lg blur-sm"></div>
                  <div className="relative w-10 h-10 bg-gradient-to-br from-orange-400/20 to-red-500/20 backdrop-blur-md border border-orange-400/30 rounded-lg flex items-center justify-center shadow-lg">
          ...
          <div className="relative group">
            {/* Electric Background Effects */}
            <div className="absolute inset-0 bg-gradient-to-br from-green-400/20 via-emerald-500/15 to-teal-600/20 rounded-2xl blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
            <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-green-400/10 to-transparent rounded-2xl animate-electric-flow"></div>
            
            {/* Main Card */}
            <div className="relative backdrop-blur-xl bg-black/30 border border-white/20 rounded-2xl shadow-2xl hover:shadow-green-400/20 transition-all duration-500 hover:border-green-400/40 hover:scale-[1.02] p-6 h-full">
              {/* Electric Particles */}
              <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none">
                <div className="absolute top-5 right-3 w-1.5 h-1.5 bg-green-400 rounded-full animate-ping opacity-75"></div>
                <div className="absolute bottom-5 left-4 w-1 h-1 bg-emerald-400 rounded-full animate-pulse opacity-60"></div>
                <div className="absolute top-8 left-12 w-1 h-1 bg-teal-400 rounded-full animate-bounce opacity-70"></div>
              </div>
              
              {/* Section Header */}
              <div className="flex items-center gap-3 mb-6 relative z-10">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-green-400/30 to-emerald-500/30 rounded-lg blur-sm"></div>
                  <div className="relative w-10 h-10 bg-gradient-to-br from-green-400/20 to-emerald-500/20 backdrop-blur-md border border-green-400/30 rounded-lg flex items-center justify-center shadow-lg">
