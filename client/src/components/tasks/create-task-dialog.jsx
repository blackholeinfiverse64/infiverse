    ...
    <Dialog open={open} onOpenChange={onOpenChange} className="dialog-overlay">
      <DialogContent className="sm:max-w-[900px] max-h-[95vh] overflow-hidden bg-black/20 backdrop-blur-3xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/40 rounded-3xl">
        ...
        <DialogHeader className="relative overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-12 bg-black/30 backdrop-blur-xl border-b border-cyan-500/40 flex items-center justify-between px-6 rounded-t-3xl shadow-lg shadow-cyan-500/20">
            <div className="flex items-center gap-3">
              <div className="w-3 h-3 bg-red-500/90 rounded-full shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"></div>
              <div className="w-3 h-3 bg-yellow-500/90 rounded-full shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"></div>
              <div className="w-3 h-3 bg-green-500/90 rounded-full shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"></div>
            </div>
            <div className="text-sm font-bold text-gray-700 bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
              Create Task
            </div>
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(6,182,212,0.25),transparent_70%)]"></div>
          
          {/* Header Content */}
          <div className="relative z-10 flex items-center gap-6 pt-16 pb-8 px-8 border-b border-cyan-500/30">
            {/* Glassmorphism Task Icon */}
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/40 to-blue-500/40 rounded-2xl blur-md group-hover:blur-lg transition-all duration-500"></div>
              <div className="relative w-20 h-20 bg-black/30 backdrop-blur-xl border border-cyan-500/50 rounded-2xl flex items-center justify-center shadow-xl shadow-cyan-500/40 group-hover:shadow-cyan-500/60 transition-all duration-500">
                <svg className="w-10 h-10 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" />
                </svg>
              </div>
              {/* Electric particles */}
              <div className="absolute -top-2 -right-2 w-4 h-4 bg-cyan-400 rounded-full opacity-80 animate-pulse"></div>
              <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-blue-500 rounded-full opacity-60 animate-pulse delay-700"></div>
              <div className="absolute top-1 right-1 w-2 h-2 bg-purple-400 rounded-full opacity-70 animate-bounce delay-300"></div>
            </div>
            
            <div className="flex-1">
              <DialogTitle className="text-4xl font-bold bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-3">
                Create New Task
              </DialogTitle>
              <DialogDescription className="text-gray-600 text-xl font-medium">
                Design and assign tasks with enhanced workflow management
              </DialogDescription>
            </div>
            
            {/* Floating elements */}
            <div className="absolute top-6 right-6 w-3 h-3 bg-cyan-400/70 rounded-full animate-bounce delay-300"></div>
            <div className="absolute bottom-6 right-10 w-2 h-2 bg-blue-500/70 rounded-full animate-bounce delay-1000"></div>
            <div className="absolute top-10 right-20 w-1 h-1 bg-purple-500/70 rounded-full animate-pulse delay-500"></div>
          </div>
        </DialogHeader>
